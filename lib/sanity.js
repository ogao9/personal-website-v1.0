...
export async function getHomeData(){
    const query = groq`*[_type == "home"][0]{
        ...
        "slot1": *[_type == "home"][0]{
          ...
          "content": slot1.data->title,
          "imageUrl": slot1.data->image.asset->url,
          "link": "/blog/" + slot1.data->slug.current,
        },
        "slot2": *[_type == "home"][0]{
            "title": slot2.title,
          "category": slot2.category,
          "content": slot2.data->title,
          "imageUrl": slot2.data->image.asset->url,
          "link": "/projects/" + slot2.data->slug.current,
        },
